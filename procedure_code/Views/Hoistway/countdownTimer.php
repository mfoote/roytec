...
<?php
	...
	$finalQuoted = decimal($QuotedTime);
	$area = substr($_POST['area'],0,7);


	if(isset($workOrder) && isset($partNumber) && isset($qty) && isset($QuotedTime) && isset($finalQuoted) && isset($area)) {
		//do nothing and stay on the same page.
	}else {
		exit(header("Location: ../Hoistway/Table_1.php"));
	}
...
<!-- countdown clock-->
	<div class = 'col-sm-6'>
		<div class=''>
			<div id='countdown' data-timer="<?=$finalQuoted * 3600 + 1?>" ></div>
		</div>
	</div>
<!-- end countdown clock-->
...
<!--Start And Stop Buttons-->
	...
	<div class="col-sm-3 h-100 center">
			...
			<button class='btn btn-warning btn-xl' id='Finished'>Finished</button>
...
<script type='text/javascript' src='../../JS/Hoistwayfinalcountdown.js'></script>
</body>
</html>
